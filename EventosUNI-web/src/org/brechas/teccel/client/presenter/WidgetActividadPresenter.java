...
public class WidgetActividadPresenter extends
	...
	protected void onBind() {
		super.onBind();
		getView().getEliminaActividad()
				.addClickHandler(eliminaActividadHandler);
	}
	...
	ClickHandler eliminaActividadHandler = new ClickHandler() {

		@Override
		public void onClick(ClickEvent event) {
			removeFromSlot(PublishEventPresenter.SLOT_Actividad,
					WidgetActividadPresenter.this);
		}
	};
}
